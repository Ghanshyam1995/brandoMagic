...
using BrandoMagic.Application.TodoItems.Commands.UpdateTodoItem;
using BrandoMagic.Application.TodoItems.Commands.UpdateTodoItemDetail;
using BrandoMagic.Application.TodoLists.Commands.CreateTodoList;
using BrandoMagic.Domain.Entities;
using BrandoMagic.Domain.Enums;
